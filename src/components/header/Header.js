...
import './custom.css'
import Logo from '../../img/906343.png'
const Header = () => {
    useEffect(() => {
        ...
        $('.more-button, .body-overlay').on('click', handleMoreButtonClick);

        // Cleanup event listeners on component unmount
        return () => {
            $('#sidebarCollapse').off('click', handleSidebarToggle);
            $('.more-button, .body-overlay').off('click', handleMoreButtonClick);
        };
    }, []);
  return (
<>
    <div className="wrapper">
        ...
        <nav id="sidebar">
            <div className="sidebar-header">
                <h3><img src={Logo} className="img-fluid"/><span>WeCommerce</span></h3>
            </div>
			...
			<li  className="active">
		      ...
		      <div className="small-screen navbar-display">
                ...
                <li className="dropdown">
					...
					<i className="material-icons">aspect_ratio</i><span>Layouts</span></a>
                ...
                <li className="dropdown">
                    <a href="#pageSubmenu2" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
					<i className="material-icons">apps</i><span>widgets</span></a>
				 ...
				 <li className="dropdown">
                    <a href="#pageSubmenu3" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
				  ...
				  <li className="dropdown">
                    <a href="#pageSubmenu4" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
					<i className="material-icons">extension</i><span>ui element</span></a>
				...
				<li className="dropdown">
                    <a href="#pageSubmenu5" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
			   ...
			   <li className="dropdown">
                    <a href="#pageSubmenu6" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
			     ...
			     <li className="dropdown">
                    <a href="#pageSubmenu7" data-toggle="collapse" aria-expanded="false" className="dropdown-toggle">
					<i className="material-icons">content_copy</i><span>Pages</span></a>
